...
namespace FstyleLottery
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            this.DataContext = new FstyleLottery.ViewModel.MainViewModel();
        }

        private void EditItemsAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            if (!Frame.Navigate(typeof(EditItemPage)))
            {
